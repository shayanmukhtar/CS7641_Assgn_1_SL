...
def main():
    gas_data = process_gas_data('./../Datasets/Gas_Data')
    pen_data = process_pen_data('./../Datasets/Pen_Data')
    bank_data = process_bank_data('./../Datasets/Banking')
    stock_data = process_stock_data('./../Datasets/Stocks', "2014")
